$(document).ready(function() {
    // Mailing List Unsubcribe Info
        ...
        .append('<p class = "termshead"> By submitting this Program Application Form, you are agreeing to the following Terms and Conditions: ​</p>')
            .append('<li class = "termslist"> Participants are required to accomplish and submit this Program Application Form at least 15 working days before program start date to reserve a slot. Those who submit after the deadline may be accommodated pending available slots upon submission of the Program Application Form and payment of the Program fee. </li>')
            ...
            .append('<li class = "termslist"> Cancellations made by fully-paid participants will be honored only through a written letter of request addressed to:​</li>')
                    ...
                    .append('<p class = "termsrequest"> E-mail:  <a href="mailto: seell@aim.edu" id = "termemail">seell@aim.edu</a> (Please state in the subject line: "Cancellation-'+ $('#ndph_seellopenprograms_name').val() +'-'+$("#fullname").val() +'") <br /></p>')
        ...
        //  $("p#enrollhead").css( { "color" : "purple", "font-weight" : "600"});
         ...
         $("b.enrollstep").css( {"font-weight" : "550", "font-size" : "15"} );
            ...
            function checkAgreements(){
                    var agreement1 = $("#ndph_agreementinfocomplete").prop("checked");
                    var agreement2 = $("#ndph_agreementcomplywithrules").prop("checked");
                    var agreement3 = $("#ndph_agreementpersonaldata").prop("checked");
         ...
         $("#ndph_yessignmeup_1").attr('type','checkbox');
         $("#ndph_yessignmeup_0").attr('type','checkbox');
         $("input#ndph_yessignmeup_1").css("margin-left","1em");
         $("legend.section-title.show-bar").css("margin-bottom","-10px");
            ...
            $("#ndph_yessignmeup_0").addClass("convertCheckbox");
    
        $("#ndph_yessignmeup_1").css({"margin-left": "20px", "margin-right": "5px"}); //no
        $("#ndph_yessignmeup_1").addClass("convertCheckbox");
    ...
    // hide fields
    $(".section[data-name='hidden_section_2']").closest("fieldset").hide();
    // $("#ndph_seellopenprograms").parent().parent().parent().hide();
