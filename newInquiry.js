$(document).ready(function() {
    ...
    function updateSchool() {
        ...
        else if (programType.val() == "649840002" || programType.val() == "649840001") {    // If Program Type is Open or Custom, set school to SEELL
    ...
    function toggleProgramType() {
        ...
        //var MaximumLengthValidatorndph_company = $("#MaximumLengthValidatorndph_company");
        ...
        switch (programType.val()) {
            case "649840000":   // Degree
                ...
                */
                companyField.show();
                $("#ndph_company").parent().removeClass("required");
                //$("#requireCompany").css("display", "none"); //hide asterisk
                industryField.show();
                //$("#requireIndustry").css("display", "none"); //hide asterisk
                //$("#requireCompany").remove(); //hide asterisk
                //$("#requireIndustry").remove(); //hide asterisk
                $("span").remove("#requireCompany");
                $("span").remove("#requireIndustry");
                $("span").remove("#requireApplicantLabel");
                seellProgramType.val("");
                $("#instructionOpenProgram").css("display", "none");
                $("#instructionDegreeProgram").css("display", "block");
            ...
            case "649840001":    // Open
                ...
                $("span").remove("#requireIndustry");
                $("span").remove("#requireApplicantLabel");
                $("#requireCompany").css("display", "block"); //show asterisk
                $("#requireIndustry").css("display", "block"); //show asterisk
                addAsterisk(); // add asterisk
                seellProgramType.val("649840000");
                $("#instructionOpenProgram").css("display", "block");
                $("#instructionDegreeProgram").css("display", "none");
                $("#instruction").css("display", "none");
                break;
            case "649840002":   // Custom
                ...
                applicanttypeField.show();
                applicanttypeField.attr("readonly", true);
                $("#instructionOpenProgram").css("display", "block");
                $("#instructionDegreeProgram").css("display", "none");
                $("#instruction").css("display", "none");
                break;
    ...
    CompanyValidator.errormessage = "<a href='#ndph_company'>Company Name is a required field.";
    ...
    CompanyValidator.evaluationfunction = function () {
        ...
        if (checkIfAffliated == "649840001" ||checkIfAffliated == "649840002"){
    ...
    ApplicantTypeValidator.errormessage = "<a href='#ndph_seellapplicanttype'>Are you inquiring as an individual or for your company/group? is a required field.";
    ...
    function addAsterisk()
    {
        ...
        var applicanttypeLabel = $("#ndph_seellapplicanttype_label");
                ...
                */
                companyLabel.before('<span id="requireCompany" style="color: maroon;">*</span>');
                industryLabel.after('<span id="requireIndustry" style="color: maroon;">&nbsp;*</span>');
                applicanttypeLabel.after('<span id="requireApplicantLabel" style="color: maroon;">&nbsp;*</span>');
    }
  ...
  //Display Counter
    ...
    $('#description_charNum').text(descriptionlength);
    ...
    $('#description').keyup(function (event) {
        ...
        if (this.value.length == max) {
            $('#description_charNum').html(x.length + addition);
    ...
    /*Dynamic Introduction Message
    var programType = $("#ndph_programtype");
        if (programType.val == "649840000") 
        {
            $("#instructionOpenProgram").css("display", "none");
            $("#instruction").css("display", "block");
        }
        else if (programType.val == "649840001") 
        {
            $("#instructionOpenProgram").css("display", "block");
            $("#instruction").css("display", "none");
        }
