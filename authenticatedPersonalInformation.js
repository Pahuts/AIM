    $(document).ready(function() {
        ...
        $('<div>')
            ...
            .append('<p class = "oep_instruct">Fill out Application Form and one of our Business Development Officers will get in touch with you shortly. Should you wish to contact us directly, email us at <a href="mailto: seell@aim.edu" id="recruitmentEmail">SEELL@aim.edu</a>.</p>')
