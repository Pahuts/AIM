$(document).ready(function() {
        ...
        .append('<p class = "termshead"> By submitting this Program Application Form, you are agreeing to the following statements: ​</p>')
        ...
        .append('<li class = "termslist"> Cancellations made by fully-paid participants will be honored only through a written letter of request addressed to:​</li>')
                ...
                .append('<p class = "termsrequest"> E-mail:  <a href="mailto: seell@aim.edu" id = "termemail">seell@aim.edu</a> (Please state in the subject line: "Cancellation-'+ params["name"] +'-'+ $("#ndph_name").val() +'") <br /></p>')
