$(document).ready(function() {
    ...
    // check seell program type
    function seellProgramType() { // shows/hides the participants tab depending on seell program type
        var seellPT = $("#ndph_seellprogramtype").val();
        // var tab = $('table[data-name="Participants_Tab"]').closest('.tab'); 
        // var label = tab.prev('.tab-title');

        if (seellPT == "649840000") {
